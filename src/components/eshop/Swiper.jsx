...
const SwiperDemo = () => {
  ...
  return (
    <>
      ...
      <div className="w-full min-h-screen flex justify-center items-center bg-[#F7ECEB]">
        {/* Desktop View with Swiper */}
        <div className="relative h-[70vh] w-[80vw] hidden md:block">
          <div 
            className="absolute left-[-5%] top-1/2 z-10 cursor-pointer bg-white/50 rounded-full p-2"
            onClick={() => swiperRef.current?.slidePrev()}
          >
            <IoIosArrowBack size={24} />
          </div>
          <div
            className="absolute right-[-5%] top-1/2 z-10 cursor-pointer bg-white/50 rounded-full p-2"
            ...
            <SwiperSlide className="w-[50vw] h-full flex justify-between items-center">
              <div className="w-[100%] h-full flex">
                <div className="w-[60%] h-full">
                  <img className="w-full h-full object-cover" src="/eshop/swipe1.avif" alt="Legacy of Khwaahish - Traditional Indian Jewelry Craftsmanship" />
                </div>
                <div className="w-[40%] h-full px-10 flex flex-col justify-center">
                  <h1 className="text-2xl md:text-4xl font-light uppercase text-amber-950 tracking-widest">Legacy of <br /> Khwaahish</h1>
                  <p className="mt-10 font-light leading-relaxed tracking-wide">Launched by the mother brand Khwaahish Diamonds, Gulz also showcases the unmistakable Indian finesse that is an integral part of every creation. While all jewellery pieces is conceived, designed and crafted in India, the brand is fearless to experiment newer horizons.</p>
                  <p className="mt-10 font-light leading-relaxed tracking-wide">The fusion of traditional techniques and contemporary design is what has always set us apart. The end product is a delightful synergy between the designer's vision and the craftsmen's great skill – all done with painstaking attention to detail and achieving an impeccable finish.</p>
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide className="w-[50vw] h-full flex justify-between items-center">
              <div className="w-[100%] h-full flex">
                <div className="w-[60%] h-full">
                  <img className="w-full h-full object-cover" src="/eshop/swipe2.avif" alt="The Curator's Tale - Luxury Diamond Jewelry Collection" />
                </div>
                <div className="w-[40%] h-full px-10 flex flex-col justify-center">
                  <h1 className="text-2xl md:text-4xl font-light uppercase text-amber-950 tracking-widest">The Curator's Tale</h1>
                  <p className="mt-10 font-light leading-relaxed tracking-wide">Our brand represents our desire to create exquisite, beautiful and high-quality diamond jewellery that is as special as you.</p>
                  <p className="mt-10 font-light leading-relaxed tracking-wide">Explore our collection at the Queen of Hearts Galleria and experience a world of Diamond Jewellery, truly Different by Design.</p>
                </div>
