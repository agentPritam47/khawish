        ...
        <div className='mx-auto w-[90%] md:w-[80%] flex flex-col md:flex-row justify-center items-center gap-8'>
          <div className='h-[50vh] md:h-[100%] w-full md:w-1/2'>
            <img 
              ...
              src="/eshop/trending.avif" 
              alt="Trending diamond rings collection" 
            />
          </div>
          <div className='w-full md:w-1/2 flex flex-col justify-center px-4 md:px-24'>
            <div>
              <h1 className='text-2xl md:text-4xl font-light uppercase text-amber-950 tracking-widest'>What's Trending</h1>
              <p className='mt-6 md:mt-10 tracking-wide font-light text-sm md:text-base'>
              ...
              <button className='mt-6 md:mt-10 tracking-[.2rem] leading-loose font-light border-b border-amber-950 float-right'>
                EXPLORE ALL RINGS
              </button>
            </div>
          </div>
